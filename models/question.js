...
var questionsArray = [
  ...
  {qID: 2, resultContent: "I am a ", questionContent: "Select your gender: ", input: "<select id='gender-select' name='answer[gender]'><option value='' disabled selected>Choose your option</option>" +
  "<option value='male'>Male</option><option value='female'>Female</option></select>"},
  {qID: 3, resultContent: "I am ", questionContent: "Select your race:", input: "<select id='race-select' name='answer[race]'>" +
    ...
    "</select>"},
  {qID: 4, resultContent: "I was born in ", questionContent: "Select your place of birth: ",
    ...
    "</select>"},
  {qID: 5, resultContent: "At home I speak ", questionContent: "Select which language you speak at home:",
    ...
    "<option value='other'>Other</option>" +
    "</select>"},
  {qID: 6, resultContent: "My education level is ", questionContent: "Select your education Level: ", input: "<select id='education-select-adult' name='answer[education]'>" +
    "<option value='' disabled selected>Choose your option</option>" +
    ...
    "</select>"},
  {qID: 7, resultContent: "I am currently ", questionContent: "Select your employment status: ", input: "<select id='employment-select' name='answer[employment]'>" +
    "<option value='' disabled selected>Choose your option</option>" +
    ...
    "</select>"},
  {qID: 8, resultContent: "My annual household income is ", questionContent: "Select your annual household income: ",
    ...
    "</select>"},
  {qID: 9, resultContent: "I currently ", questionContent: "I currently: ",
    input: "<select id='tenure-select' name='answer[tenure]'>" +
    "<option value='' disabled selected>Choose your option</option>" +
    "<option value='own'>Own</option>" +
    "<option value='rent'>Rent</option>" +
    "</select>"},
  {qID: 10, resultContent: "I live in a ", questionContent: "I live in a: ",
    ...
    "</select>"},
  {qID: 11, resultContent: "My marital status is ", questionContent: "Select your marital status", input: "<select id='marital-status-select' name='answer[maritalStatus]'>" +
    "<option value='' disabled selected>Choose your option</option>" +
