...
var questionsArray = [
  {_id: "1", resultContent: "You are ", questionContent: "How old are you? ", input: "<input type='number' class='number-input' min='1' max='122' step='1' id='age-select' name='answer[age]' />"},
  {_id: "2", resultContent: "You were born on ", questionContent: "Enter your birthday: ", input: "<input class='date-input' id='birthday-input' type='date' />"},
  {_id: "3", resultContent: "Your first name is ", questionContent: "Enter your first name: ",
    input: "<input class='text-input' id='name-input' type='text' name='answer[name]'/>"},
  {_id: "4", resultContent: "You are a ", questionContent: "Gender: ", input: "<select class='select-input' id='gender-select' name='answer[gender]'>" +
    "<option value='male'>Male</option>" +
    "<option value='female'>Female</option></select>"},
  {_id: "", resultContent: "You live in ", questionContent: "I live in: ",
    input: "<input class='text-input' id='location-input' type='text' name='answer[location]' placeholder='City, State'/>"},
  {_id: "5", resultContent: "Your hair color is: ", questionContent: "Hair Color: ", input: "<select class='select-input' id='hair-color-select' name='answer[hairColor]'>" +
    ...
    "</select>"},
  {_id: "6", resultContent: "Your eye color is: ", questionContent: "Eye Color: ", input: "<select class='select-input' id='eye-color-select' name='answer[eyeColor]'>" +
    "<option value='blue'>Blue</option>" +
    "<option value='brown'>Brown</option>" +
    "<option value='green'>Green</option>" +
    "<option value='hazel'>Hazel</option>" +
    "</select>"},
  {_id: "7", resultContent: "Your height is ", questionContent: "Height: ", input: "Feet: <input type='number' class='number-input' min='4' max='6' step='1' id='height-feet-select' name='answer[height.feet]' />" +
    "Inches: <input type='number' class='number-input' min='0' max='11' step='1' id='height-inches-select' name='answer[height.inches]' />"},
  {_id: "8", resultContent: "Your weight is ", questionContent: "Weight: ", input: "<input type='number' class='number-input' min='80' max='400' step='1' id='weight-select' name='answer[weight]' />"},

  {_id: "9", resultContent: "You are ", questionContent: "Race: (choose one or more) ", input: "<select class='select-input' id='race-select' name='answer[race]' multiple='true'>" +
    ...
    "</select>"},
  {_id: "10", resultContent: "You were born in ", questionContent: "I was born in: ",
    ...
    "</select>"},
  {_id: "11", resultContent: "At home I speak ", questionContent: "What language do you speak at home?",
    ...
    "<option value='other'>Other</option>" +
    "</select>"},
  {_id: "12", resultContent: "You are ", questionContent: "Religion: ", input: "<select class='select-input' id='religion-select' name='answer[religion]'>" +
    ...
    "</select>"},
  {_id: "13", resultContent: "Your education level is ", questionContent: "Education Level: ", input: "<select class='select-input' id='education-select-adult' name='answer[education]'>" +
    ...
    "</select>"},
  {_id: "14", resultContent: "You are currently ", questionContent: "Employment Status: ", input: "<select class='select-input' id='employment-select' name='answer[employment]'>" +
    ...
    "</optgroup>"},
  {_id: "15", resultContent: "My household income is ", questionContent: "Household income: ",
    ...
    "</select>"},
  {_id: "16", resultContent: "You currently ", questionContent: "I currently: ",
    input: "<select class='select-input' id='tenure-select' name='answer[tenure]'>" +
    "<option value='rent'>Rent</option>" +
    "<option value='own'>Own</option>" +
    "</select>"},
  {_id: "17", resultContent: "You live in a ", questionContent: "I live in a: ",
    ...
    "</select>"},
  {_id: "18", resultContent: "Your veteran status is ", questionContent: "Veteran status: ",
    ...
    "</select>"},
  {_id: "19", resultContent: "Your marital status is ", questionContent: "Marital Status", input: "<select class='select-input' id='marital-status-select' name='answer[maritalStatus]'>" +
